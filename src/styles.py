...
def inject_styles():
    ...
    /* ─── App Header Banner ─────────────────────────────────────── */
    .app-header {
        background: linear-gradient(135deg, #06091a 0%, #0b1120 60%, #0f1a35 100%);
        padding: 1.4rem 2rem;
    ...
    /* ── Sidebar text: make all labels clearly readable ── */

    /* Section headings (h2/h3 used as divider labels) */
    ...
    /* Widget labels — bright enough to read easily on dark sidebar */
    ...
    /* Selected value text inside dropdowns — must be clearly white */
    ...
    /* Sidebar warning / success alerts */
    ...
    .ag-theme-streamlit {
        ...
        box-shadow: 0 2px 8px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(255, 255, 255, 0.05) !important;
    ...
    .ag-header {
        background: linear-gradient(135deg, #06091a 0%, #0b1120 100%) !important;
